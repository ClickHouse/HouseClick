...
interface FilterProps {
  items: AnalyticFilter[];
  selected: AnalyticFilter;
  onChange: (item: AnalyticFilter) => void;
}
...
export default function AnalyticFilterPanel({ items, selected, onChange }: FilterProps) {
  const selectedItem = items.find((item) => item.id === selected.id) || items[0];
