...
import { fetchAnalytics } from "@/app/actions/analyticsActions";
import { useState, useEffect } from "react";
import AnalyticFilterPanel from "@/components/AnalyticFilterPanel";
...
export default function Analytics({ filters }: AnalyticsProps) {
    ...
    useEffect (() => {
        fetchAnalytics(selectedFilter).then((data) => {;
            setData(data);
        });
    }, []);
